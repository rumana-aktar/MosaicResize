...
%RL=dlmread('/D/NGA/Output1.3/MondayPresentation/FUSE/TraceVideo/Files/Homographies/3_ReferenceList.txt');
%R=RL(:,1)';R=R-R(1,1)+1;S=R(1, 2:end);
%input and output directory
dirname='/Volumes/D/MM-MM/MM/MM-to-MM/input1_6_EdgeFeatureRemoved';
dirnameOut='/Volumes/D/MM-MM/MM/MM-to-MM/input1_6_EdgeFeatureRemoved/';
if (~isdir(dirnameOut))
    mkdir(dirnameOut);
end
